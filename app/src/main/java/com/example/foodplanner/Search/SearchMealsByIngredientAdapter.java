...
public class SearchMealsByIngredientAdapter extends RecyclerView.Adapter<SearchMealsByIngredientAdapter.ViewHolder>{
    private static final String TAG = "SearchMealsByIngredient";
    Context context;
    List<Meal> meals;
    ...
    public SearchMealsByIngredientAdapter(Context context, List<Meal> meals, AllMealsView listener) {
    ...
    @NonNull
    @Override
    public SearchMealsByIngredientAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        Log.i(TAG, "onCreateViewHolder: ");
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View view = inflater.inflate(R.layout.item_meal, parent, false);
        SearchMealsByIngredientAdapter.ViewHolder viewHolder = new SearchMealsByIngredientAdapter.ViewHolder(view);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull SearchMealsByIngredientAdapter.ViewHolder holder, int position) {
        ...
        holder.cardMeal.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Pass ingredientName to the presenter method
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            if (constraint == null || constraint.length() == 0) {
                ...
                for (Meal meal : mealList) {
                    if (meal.getStrIngredient1().toLowerCase().contains(filterPattern)) {
